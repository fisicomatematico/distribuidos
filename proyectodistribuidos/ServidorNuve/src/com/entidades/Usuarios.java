...
public class Usuarios implements Serializable{
	...
	public Usuarios(int usuarioId, String nombres, String email, Date fecha, String usuario, String clave,
			String tockenEscritorio, String tockenWeb, String tockenAndroid) {
		super();
	...
	public String toString() {
		return "Usuarios [usuarioId=" + usuarioId + ", nombres=" + nombres + ", email=" + email + ", fecha=" + fecha
				+ ", usuario=" + usuario + ", clave=" + clave + ", tockenEscritorio=" + tockenEscritorio
				+ ", tockenWeb=" + tockenWeb + ", tockenAndroid=" + tockenAndroid + "]";
	}
